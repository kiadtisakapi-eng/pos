...
├── app.js                  # Logic ทั้งหมด (class PosApp, ~3,300 บรรทัด)
├── style.css               # Dark Premium CSS Design System (~1,520 บรรทัด)
├── sw.js                   # Service Worker — cache offline (v19)
...
```
Service Worker (jahn-pos-v19)
├── install   → cache: index.html, app.js, style.css, manifest.json
...
jahn_pos_transactions     → ประวัติบิล (auto-archive > 180 วัน + synced)
...
*เอกสารนี้สร้างอัตโนมัติจากการวิเคราะห์โค้ด — อัปเดตล่าสุด: มิถุนายน 2569*
